                  ...
                  {products?.map((product) => (
                    <TableRow key={product.id}>
                      ...
                      <TableCell className="text-right">
                        <Button size="icon" variant="ghost" onClick={() => { setEditProduct(product); setDialogOpen(true); }}>
                          <Pencil className="h-4 w-4" />
                        </Button>
                        <Button size="icon" variant="ghost" onClick={() => confirm(`Delete ${product.name}?`) && deleteProduct.mutate(product.id)}>
